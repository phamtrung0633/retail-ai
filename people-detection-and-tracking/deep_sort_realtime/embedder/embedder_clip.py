...
class Clip_Embedder(object):
    ...
    - model_wts_path (optional, str): Optional specification of path to CLIP model weights. Defaults to None and look for weights in `l/embedder/weights` or clip will download from internet into their own cache.
